...
def main(rep, patch_num, is_heterogeneity, reproduce_mode, total_disp_among_rate, disp_within_rate, patch_dist_rate, goal_path=None, rank=0, job_num=1, task_idx=1):
    ...
    for time_step in range(all_time_step): 
        ...
        if reproduce_mode == 'asexual':
            ...
            write_in_logger_info += meta_obj.dispersal_among_patches_in_global_habitat_network_from_offspring_marker_pool_to_immigrant_marker_pool(total_disp_among_rate, method='exponential', rho=2)
...
if __name__ == '__main__':
    main(rep=0, patch_num=16, is_heterogeneity=False, reproduce_mode='asexual', total_disp_among_rate=0.1, disp_within_rate=0.1, patch_dist_rate=0.00001, goal_path=None)
