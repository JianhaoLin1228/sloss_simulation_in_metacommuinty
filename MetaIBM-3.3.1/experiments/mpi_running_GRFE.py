...
for a_piece_of_work in this_worker_job_para:
    ...
    time.sleep(5)
    goal_path = mkdir_if_not_exist(reproduce_mode, patch_num, is_same_heterogeneity, (disp_among_rate, disp_within_rate), patch_dist_rate, root_path='/scratch/project_2018377/ljianhao/SLOSS_GRFE/rep=0')
