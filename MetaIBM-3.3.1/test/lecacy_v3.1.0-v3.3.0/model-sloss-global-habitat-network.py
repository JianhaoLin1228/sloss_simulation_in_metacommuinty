...
if __name__ == '__main__':
    main(rep=0, patch_num=4, is_heterogeneity=False, reproduce_mode='asexual', total_disp_among_rate=0.1, disp_within_rate=0.1, patch_dist_rate=0.00001, goal_path=None)
